...
python3 train_imb.py --model ensemble --suffix baseline1 --dataset CIFAR100V2 --imb_factor 0.01 \
 --KD_ensemble True \
 --ensemble1 ensemble/CIFAR100V2_resnet32_resnet32_reviewkd1_256_best_1.pt \
 --ensemble2 ensemble/CIFAR100V2_resnet32_resnet32_reviewkd1_256_best_2.pt \
 --ensemble3 ensemble/CIFAR100V2_resnet32_resnet32_reviewkd1_256_best_3.pt